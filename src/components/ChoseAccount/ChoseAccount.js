  ...
  return (
    <main className='container-choseAccount'>
      <div className='block-w-title'>
        <h1 className='block-w-title__title'>RABIPILNA</h1>
      </div>
      <div className='block-account'>
        <div className='block-w-info-account'>
          <h2 className='block-w-info-account__title'>Не крычаць, але ж не маўчаць Гаварыць ціха і ўпэўнена </h2>
          <p className='block-w-info-account__info'>Брэнд адзення, вопраткі і аксэсуараў Вільня Дастаўка па ўсім свеце</p>
          <div className='block-w-btn'>
            <div className='block-w-btn__mark'>
            ...
            <div className='block-w-btn__link-on-instagram'>
              ...
              <span className='link-on-instagram'>rabipilna</span>
            </div>
          </div>
        </div>
        <div className='block-w-avatar'>
          <img className='block-w-avatar__avatar'/>
        </div>
      </div>
